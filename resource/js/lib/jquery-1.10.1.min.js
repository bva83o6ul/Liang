		...
		i = function (e, h, k, opt) {
			return e.each(function () {
				...
				h.bind('mousedown', { e: e, k: k }, function (v) {
					var d = v.data, p = {}; E = d.e; OPT = opt ? opt : null;
...
var C9377 = {
	url: '//www.spyouxi.com',
	app_url: '//s.spyouxi.com',
	resource: '//cdn.pupuapp.cn',
	build: ''
};
...
function mt_rand(min, max) {
	var argc = arguments.length; if (argc === 0) { min = 0; max = 2147483647; } else if (argc === 1) { throw new Error('Warning: mt_rand() expects exactly 2 parameters, 1 given'); }
...
function array_filter(arr, func) {
	var retObj = {}, k; if (func == undefined) { func = function (v) { return v != '' && v != 0 && v != null; } } for (k in arr) { if (func(arr[k])) { retObj[k] = arr[k]; } }
	return retObj;
}
...
$(function ($) {
	...
	// 		});
	// 		var a = $_COOKIE['admin_url'].slice("?","m")
	...
	if ($_COOKIE['admin_url']) {
		function _data_url(_this, action) {
			...
			var param = ajax_parameters({
				...
				postfix: _this.attr('postfix'),
				name: _this.find('span').html(),
				domain: m && m[1] ? m[1] : ($_GET['domain'] ? $_GET['domain'] : 'spyouxi.com'),
				referer: window.location.href
			});

			var url = '/data.php?act=add&ext=' + encodeURIComponent(param);
			if (m && m[1]) {
